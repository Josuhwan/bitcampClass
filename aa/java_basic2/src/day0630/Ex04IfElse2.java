...
//0보다 큰지 확인해서 0보다 크면"양의 정수입니다"라고 출력되고
//0보다 작거나 같으면 "양의 정수가 아닙니다"라고 출력되는 프로그램을 작성하시오.

//2.사용자로부터 나이를 입력받아서 19세 미만일경우 "미성년자 입니다"라고 출력되고 
//그 외는 "성인입니다"가 출력되는 코드를 만드시오

//3.사용자로부터 숫자를 하나 입력받아서 그 숫가다 홀수이면 "홀수입니다"가 출력되고 
//짝수이면 "짝수입니다"가 출력되는 코드를 만드시오

//4.사용자로부터 숫자를 입력받아서 해당 숫자가 10부터 99사이의 두자리 숫자이면 
//"두자리 숫자입니다" 라고 출력되고 그 외는 "두자리 숫자가 아닙니다"가 출력되는 코드를 만드시오

//5.사용자가 숫자를 입력하면 그 숫자가 음수이거나 1000보다 크면
//"잘못 입력하셨습니다."라고 출력되고 그 외는 "올바른 값입니다"가 출력되게 코드를 만드시오
