...
// 연산자란, 수학적 기호에 프로그래밍 기능이 정의 되어있어서
...
public class Ex01Opeartor {
    public static void main(String[] args) {
        ...
        // 실수형 데이터타입 끼리의 연산
        // 1. double 변수 myDouble1 과 myDouble2를 선언하고
        //    각각 5.0 과 3.0 으로 초기화
        ...
        // 정수와 실수를 연산해보자
        System.out.println("1. num1 + myDouble1");
        System.out.println(num1 + myDouble1);
        
        System.out.println("2. num1 - myDouble1");
        System.out.println(num1 - myDouble1);
        
        System.out.println("3. num1 * myDouble1");
        System.out.println(num1 * myDouble1);
        
        System.out.println("4. num1 / myDouble1");
        System.out.println(num1 / myDouble1);
        
        System.out.println("5. num1 % myDouble1");
        System.out.println(num1 % myDouble1);
        ...
        // String 도 하나의 데이터타입이기 때문에 우리가 변수로 만들 수 있는데
        ...
        // 한개의 커다란 String으로 연결해라 라는 의미가 된다.
        // 예시 1. 스트링 + 스트링
        System.out.println(name+"입니다.");
        // 예시 2. 스트링 + 다른 데이터타입 or 다른 데이터타입 + 스트링
        // 이 때에는 다른 데이터타입의 값이 스트링으로 변환이 되고
