...
public class Ex01Test {
    public static void main(String[] args) {
        ...
        // 이제는 배열을 초기화해줄때 크기를 0으로 초기화해준다.

        int[] arr = new int[0];

        // 1. int[] 기준
        // A. size()
        System.out.println("1-A. siz(): " + ArrayUtil.size(arr));
        // B. isEmpty()
        ...
        System.out.println("-------------");
        // 1-C. size()
        System.out.println("1-C. siz(): " + ArrayUtil.size(arr));
        // 1-D. isEmpty()
        ...
        System.out.println("1-G. indexOf(2): " + ArrayUtil.indexOf(arr, 450));
        // 1-H. add(arr, index, e)
        System.out.println("1-H. add() 전 get(2): " + ArrayUtil.get(arr, 2));
        arr = ArrayUtil.add(arr, 2, 30);
        System.out.println("1-H. add() 전 get(2): " + ArrayUtil.get(arr, 2));
        // 1-I. set()
        System.out.println("1-I. set() 전 size(2): " + ArrayUtil.size(arr));
