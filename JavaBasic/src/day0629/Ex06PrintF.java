...
public class Ex06PrintF {
    public static void main(String[] args) {
        // int 변수 number를 선언하고 12497로 초기화한다.
        int number = 12497;
        ...
        // 3. 여러개의 %문자를 섞어서 쓸 수도 있지만
        // 반드시 뒤의 값의 갯수가 %문자보다는 많아야 된다!
        System.out.printf("%f %d %f %s\n", 1.2, 3, 4.5, "abc", 34);
        // 하지만 %문자의 갯수가 더 많으면 에러가 발생하낟.
        // System.out.printf("%d %d %d\n", 1, 2);

        // 4. 여러분들이 주로 하시는 실수중에 다음과 같은 실수가 있다.
        // System.out.printf("%4\n", 3);
